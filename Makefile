...
composer-install:
	docker exec -t  test-server-php composer install
fresh-migrate:
	docker exec -t  test-server-php php artisan migrate:fresh
db-seed:
	docker exec -t  test-server-php  php artisan db:seed
